              ...
              |> case do
                ...
                response ->
                  try do
                    ...
                    {:parse_error, module, function} ->
                      Logger.error(
                        "Failed to parse a response: #{inspect(response)}"
                      )

                      Kernel.reraise(
                        "Parse error during #{inspect(module)}.parse_response, in #{
                          inspect(module)
                        }.#{inspect(function)}. Couldn't parse: #{
                          inspect(response)
                        }",
                        __STACKTRACE__
                      )
